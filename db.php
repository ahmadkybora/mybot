...
define('DB_USER', 'ahmadkybora');
define('DB_PASS', '09392141724abc');
define('DB_NAME', 'bot_telegram');
...
class DB {
    ...
    public function __construct()
    {
        ...
        {
            echo "Connection field: " . $this->connection->connect_error;
            exit;
        }
    ...
    public function modify($sql, $data = array())
    {
        ...
        if(!$result) {
            echo "Query: " . $sql . " field due to " . mysqli_error($this->connection);
            exit;
        }
